...
from tests.external_dependencies import mock_env, mock_varchar_table, mock_managed_product
...
class Test(TestCase):
    ...
    def test_get_vendor_config_missing(*_args):
        ...
        config = Database.get_vendor_config(self=instance, settings_table="", vendor_id="rh")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_status_false(*_args):
        ...
        instance.return_value = False
        config = Database.get_vendor_status(self=instance, vendors_table="", vendor_id="rh")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_create_managed_product(*_args):
        ...
        new_managed_product = Database.create_managed_product(
            self=instance, managed_products_table="", name="", versions="", vendor_priorities="", vendor_statuses="",
            vendor_resolutions="", vendor_id="rh"
        )
