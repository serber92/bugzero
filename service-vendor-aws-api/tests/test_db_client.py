...
class Test(TestCase):
    ...
    def test_get_vendor_config_missing(*_args):
        ...
        config = Database.get_service_config(self=instance, settings_table="", vendor_id="aws")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_status_false(*_args):
        ...
        instance.return_value = False
        config = Database.get_vendor_settings(self=instance, vendors_table="", vendor_id="aws")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_create_managed_product(*_args):
        ...
        new_managed_product = Database.create_managed_product(
            self=instance, managed_products_table="", name="", vendor_id="aws",
            service_settings={
                "vendorPriorities": [], "vendorStatuses": [], "vendorEventScopes": [], "vendorRegions": []
            }
        )
    ...
    def test_update_managed_product_versions(*_args):
        ...
        assert not Database.update_managed_product_versions(
            self=instance, managed_product=mock_managed_product[0], versions=["1.1", "2.2"], major_versions=["1", "2"]
        )
        del sys.modules['db_client']
    ...
    def test_insert_bug_updates(*_args):
        ...
        assert execution["inserted_bugs"] == 9
        del sys.modules['db_client']
    ...
    def test_remove_bugs_by_managed_product_id(*_args):
        ...
        Database.remove_bugs_by_managed_product_id(
            self=instance, bugs_table="", managed_product=mock_managed_product[0]
        )
        assert True
        del sys.modules['db_client']
