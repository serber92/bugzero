export default {
  hpe: {
    ...
    type: 'hardware',
    managedProductForm: {
      productLinkText: 'Links ServiceNow CMDB products to BugZero supported products (e.g. HP DL380 Gen8)'
    },
    cmdb: {
      products: {
        sysparm_query: 'manufacturerLIKEHP^ORmanufacturerLIKEHewlett-Packard^ORmanufacturerLIKEHewlett Packard',
  ...
  rh: {
    ...
    type: 'software',
    managedProductForm: {
      productLinkText: 'Links ServiceNow CMDB products to BugZero supported products (e.g. Redhat Enterprise Linux 8)'
    },
    cmdb: {
      products: {
  ...
  msft: {
    ...
    type: 'software',
    managedProductForm: {
      productLinkText: 'Links ServiceNow CMDB products to BugZero supported products (e.g. SQL Server)'
    },
    priorities: [
      {
        label: 'Unspecified',
  ...
  cisco: {
    ...
    type: 'hardware',
    managedProductForm: {
      productLinkText: 'Links ServiceNow CMDB products to BugZero supported products (e.g. Cisco Catalyst 6500)'
    },
    cmdb: {
      products: {
        sysparm_query: 'install_status=1^operational_status=1^manufacturerLIKECisco^ORshort_descriptionLIKECisco',
  ...
  mongodb: {
    ...
    type: 'software',
    managedProductForm: {
      productLinkText: 'Links ServiceNow CMDB products to BugZero supported products (e.g. MongoDB Server)'
    },
    cmdb: {
      products: {
        sysparm_query: 'install_status=1^operational_status=1^manufacturerLIKEMongo^ORshort_descriptionLIKEMongo',
        sysparm_fields: 'manufacturer,sys_id,display_name,sys_class_name'
      }
    },
    priorities: [
  ...
  aws: {
    ...
    eventScopes: [{ label: 'Public', value: 'Public' }, { label: 'Account Specific', value: 'Account Specific' }]
  },
  msft365: {
    vendorId: 'msft365',
    name: 'Microsoft 365',
