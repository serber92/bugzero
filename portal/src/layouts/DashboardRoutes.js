...
import GetHelp from '../components/page/GetHelp';
...
/* integration */
import IntegrationSettings from '../components/page/IntegrationSettings';

/* managed products */
import ManagedProductListing from '../components/page/ManagedProductListing';
import ManagedProductConfig from '../components/page/ManagedProductConfig';
import ManagedProductEdit from '../components/page/ManagedProductEdit';
import CreateSupportTicket from '../components/page/CreateSupportTicket';
...
const ProductRoutes = ({ match: { url } }) => (
  <Switch>
    <Route path={`${url}/:vendorId/products`} exact component={ManagedProductListing} />
    <Route path={`${url}/:vendorId/configuration`} exact component={ManagedProductConfig} />
    <Route path={`${url}/:vendorId/products/new`} exact component={ManagedProductEdit} />
    <Route path={`${url}/:vendorId/products/:managedProductId`} exact component={ManagedProductEdit} />

    {/*Redirect*/}
    <Redirect to="/errors/404" />
  </Switch>
);
const IntegrationRoutes = ({ match: { url } }) => (
  <Switch>
    <Route path={`${url}/servicenow`} exact component={IntegrationSettings} />
...
const DashboardRoutes = () => (
  <Switch>
    ...
    <Route path="/support/create-ticket" exact component={CreateSupportTicket} />
    <Route path="/support/get-help" exact component={GetHelp} />
    ...
    {/* E commerce*/}
    <Route path="/vendors" component={ProductRoutes} />
