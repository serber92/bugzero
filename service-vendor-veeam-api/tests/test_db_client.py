...
class Test(TestCase):
    ...
    def test_get_vendor_config_missing(*_args):
        ...
        config = Database.get_service_config(self=instance, settings_table="", vendor_id="veeam")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_status_false(*_args):
        ...
        instance.return_value = False
        config = Database.get_vendor_settings(self=instance, vendors_table="", vendor_id="veeam")
        assert not config
        del sys.modules['db_client']
    ...
    def test_get_vendor_create_managed_product(*_args):
        ...
        new_managed_product = Database.create_managed_product(
            self=instance, managed_products_table="", name="", versions="", major_versions="",
            service_settings={"vendorPriorities": [], "vendorStatuses": []}, vendor_id="veeam", vendor_product_id="1"
        )
